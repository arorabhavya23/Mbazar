...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<section>
       ...
       <%--                                 <asp:DataList ID="DataList1" runat="server" RepeatColumns="3" OnSelectedIndexChanged="DataList1_SelectedIndexChanged">--%>
                                            <ItemTemplate>
                                                <img id="image1" runat="server" src='<%#Eval("ProImages") %>' alt="" width="200" height="200" />
										<h2> <asp:Label ID="Label2" runat="server" Text='<%#Eval("proname") %>'></asp:Label></h2>
                                                <p>
                                            <asp:Label ID="Label1" runat="server" Text='<%#Eval("proprice") %>'></asp:Label></p>
	...
	<footer id="footer"><!--Footer-->
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright © 2015 M-BAZAAR Rights reserved.</p>
				</div>
			</div>
		</div>
